...
<div class="heart_img"><img src="images/images_heart.png" alt="heaert"></div>
            ...
            <section id="menubar">
				...
				<ul class="nav nav-tabs">
				  <li class="active"><a data-toggle="tab" href="#Newstupload">Newst Upload</a></li>
				 
				  <li v-for="categori, index in categories"><a data-toggle="tab" :href="'#newsCat' +categori.id" @click="showNewsResCat(categori.id)">{{ categori.name }}</a></li>
...
           },///End,
  ...
  console.log(id);
   var vm = this
                 axios.get(`/showAllNewsResCat/${id}`)
          .then(response => {
             vm.newses = response.data
			 console.log(response)
            console.log(response.data)
           serverBus.$emit('serverSelectedNews', response.data);
          })
          .catch(error => {
            console.log(error)
          })
