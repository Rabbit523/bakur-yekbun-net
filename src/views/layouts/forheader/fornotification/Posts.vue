...
#tabss ul li:first-child {
  -webkit-border-top-left-radius: 3px;
  -moz-border-radius-topleft: 3px;
  border-top-left-radius: 3px;
  border-right: 1px solid #e5e5e2;
}
#tabss ul li:last-child {
...
#tabss ul .ui-tabs-active {
  background: #fff;
  border-bottom: none;
}
#tabss ul .ui-tabs-active a {
  color: #000;
}
#tabss ul .ui-tabs-active span {
  color: #609c09;
}
#tabss h3, #tabs h4 {
  font-family: 'Josefin Sans', sans-serif;
...
<div id="Postsbox" class="shopping-cart" style="display: none;">
   <div id='tabss'>
