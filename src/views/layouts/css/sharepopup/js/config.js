...
Config.init_emoticons = function() {
  ...
  for (var i in Config.emoticons_data) {
    ...
    Config.map.emoticons[emoticon] =
      Config.map.colons[Config.emoticons_data[i]];
...
function buildMap() {
  ...
  for (var i in Config.emoji_data) {
    for (var j = 0; j < Config.emoji_data[i][0].length; j++) {
      ...
      Config.mapcolon[":" + Config.emoji_data[i][3][0] + ":"] =
        Config.emoji_data[i][0][0];
      // it is a map of {"unicode char": "colon smiley"}
      Config.reversemap[Config.emoji_data[i][0][0]] =
        Config.emoji_data[i][3][0];
    }
