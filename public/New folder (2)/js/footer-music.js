...
var tracklist = [
		{
			...
			"source": "https://koenigsegg1.000webhostapp.com/codepen/09%20Not%20Backing%20Down%20(feat.%20Tedashii).mp3",
			"length": "3:24",
			"star": "4",
			"price": ""
		},
...
for (var i = 0; i < tracklist.length; ++i) {
	$('footer .tracks').append("<div class='up-next flex' data-tracklistNumber='" + i + "'><div class='left flex align-center'><img src='" + tracklist[i].artwork + "'/><div class='info' style='background-color: inherit'><p>" + tracklist[i].song + "</p><p>" + tracklist[i].artist + "</p></div></div><div class='right flex align-center'><div class='length'>" + tracklist[i].length + "</div><i style='color:rgba(11, 11, 11, 0.25);margin-left: 40px;font-size: 20px;' class='fa fa-share-alt'></i>" + "<i style='color:rgba(11, 11, 11, 0.25);margin-left: 50px;font-size: 20px;' class='fa fa-trash'></i>" + "<i style='color: rgba(11, 11, 11, 0.25);margin-left: 40px;font-size: 20px;' class='fa fa-exchange'></i>" +	"</div></div>");
}
